...
HD_PWD='D:/Vivado2018_wrk/axi_spi/axi_spi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_spi_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_spi_top_wrapper.tcl -notrace

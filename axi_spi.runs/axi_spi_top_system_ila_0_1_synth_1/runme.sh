...
HD_PWD='D:/Vivado2018_wrk/axi_spi/axi_spi.runs/axi_spi_top_system_ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_spi_top_system_ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_spi_top_system_ila_0_1.tcl

...
################################################################
# This is a generated script based on design: bd_bc67
#
...
proc create_root_design { parentCell } {
  ...
  set probe0 [ create_bd_port -dir I -from 61 -to 0 probe0 ]
  set probe1 [ create_bd_port -dir I -from 61 -to 0 probe1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ILA_CLK_FREQ {12500000} \
   CONFIG.C_INPUT_PIPE_STAGES {0} \
   CONFIG.C_MONITOR_TYPE {Native} \
   CONFIG.C_NUM_OF_PROBES {2} \
   CONFIG.C_PROBE0_MU_CNT {1} \
   CONFIG.C_PROBE0_TYPE {0} \
   CONFIG.C_PROBE0_WIDTH {62} \
   CONFIG.C_PROBE1_MU_CNT {1} \
   CONFIG.C_PROBE1_TYPE {0} \
   CONFIG.C_PROBE1_WIDTH {62} \

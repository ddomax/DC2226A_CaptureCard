...
################################################################
# This is a generated script based on design: bd_7cc6
#
...
proc create_root_design { parentCell } {
  ...
  set probe4 [ create_bd_port -dir I -from 3 -to 0 probe4 ]
  set probe5 [ create_bd_port -dir I -from 3 -to 0 probe5 ]
  set probe6 [ create_bd_port -dir I -from 3 -to 0 probe6 ]
  set probe7 [ create_bd_port -dir I -from 3 -to 0 probe7 ]

...
//--------------------------------------------------------------------------------
//Command: generate_target bd_bc97.bd
//Design : bd_bc97
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_bc97,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_bc97,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "axi_spi_top_system_ila_0_1.hwdef" *) 
module bd_bc97
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arprot,
    SLOT_0_AXI_arready,
    ...
    probe9,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 7, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN axi_spi_top_clk_wiz_0_0_clk_out1, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [6:0]SLOT_0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI AWADDR" *) input [6:0]SLOT_0_AXI_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN axi_spi_top_clk_wiz_0_0_clk_out1, FREQ_HZ 100000000, PHASE 0.0" *) input clk;
  input [0:0]probe0;
  input [0:0]probe1;
  input [4:0]probe10;
  input [31:0]probe11;
  ...
  wire [6:0]net_slot_0_axi_araddr;
  ...
  wire [6:0]net_slot_0_axi_awaddr;
  ...
  bd_bc97_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe11(probe11_1),
        .probe12(probe12_1),
        .probe13(net_slot_0_axi_ar_cnt),
        .probe14(net_slot_0_axi_araddr),
        .probe15(net_slot_0_axi_arprot),
        .probe16(net_slot_0_axi_aw_cnt),
        .probe17(net_slot_0_axi_awaddr),
        .probe18(net_slot_0_axi_awprot),
        .probe19(net_slot_0_axi_b_cnt),
        .probe2(probe2_1),
        .probe20(net_slot_0_axi_bresp),
        .probe21(net_slot_0_axi_r_cnt),
        .probe22(net_slot_0_axi_rdata),
        .probe23(net_slot_0_axi_rresp),
